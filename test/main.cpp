...
public:
    ...
    virtual void SetUp() // TESTè·ä¹åä¼æ§è¡SetUp
    {
        std::cout << "SetUp" << std::endl;
    }
    virtual void TearDown() // TESTè·å®ä¹åä¼æ§è¡TearDown
    {
...
TEST_F(TestMap, MathConstant)
{
    ...
    std::string l2_text = {
#include "../LibDecimal/source/20000_digits_of_ln2.txt"
    };
    ...
    std::string E_text = {
#include "../LibDecimal/source/100000_digits_of_e.txt"
    };
